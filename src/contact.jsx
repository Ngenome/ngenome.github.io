    ...
    <div className="contact-page">
      <Helmet>
        ...
        <meta
          ...
          content="Got a question for the team at Jipas Tentsail? Please fill out the form below and we will get back to you as soon as possible. Alternatively, contact us by phone or whatsapp."
        />
        <meta
          property="og:title"
          content="Jipas Tensail Architectural|Contact "
        />
      </Helmet>
      ...
      <div className="forms">
        <form action="" className="contact-form">
          ...
          <div className="wrap">
            <label htmlFor="url" id="web-label">
              Subject
            </label>
            <input
              type="text"
        ...
        >
          ...
          >
            <div className="c-ds">
              ...
              <a href="mailto:jipasgarments@gmail.com">Email us</a>
            </div>
            ...
            <div className="c-ds">
              ...
              <a href="tel:0736886886">Call us</a>
            </div>
          </div>
        </div>
      </div>
